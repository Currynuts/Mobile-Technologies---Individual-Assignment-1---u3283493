...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- Fourth Button: SQLite ---
        Button btnSQLite = findViewById(R.id.buttonSQLite);
        ...
        // --- Fifth Button: Animation ---
        Button btnAnimation = findViewById(R.id.buttonAnimation);
        ...
        // --- Sixth Button: Multimedia ---
        Button btnMultimedia = findViewById(R.id.buttonMultimedia);
